...
import { getStoryByTitle, entrollToStory } from '@/app/api/story-api';
...
export default function VideoIntroPage() {
  ...
  useEffect(() => {
    const fetchStory = async () => {
      try {
        const storyData = await getStoryByTitle("The Grand Celebration");
        setStory(storyData);
      } catch (error: any) {
  ...
  return (
    <div className="relative w-full h-screen bg-black overflow-hidden">
      ...
      <video
        ...
        muted={!soundEnabled}
      >
        <source src="/assets/animations/Chapter12.mp4" type="video/mp4" />
