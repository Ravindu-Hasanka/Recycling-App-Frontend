...
import { entrollToStory, getStoryByTitle } from '@/app/api/story-api';
  ...
  const [story, setStory] = useState<Story | null>(null);
    ...
    useEffect(() => {
      const fetchStory = async () => {
        try {
          const storyData = await getStoryByTitle("The River Rescue");
          setStory(storyData);
        } catch (error: any) {
  ...
  return (
    <div className="relative w-full h-screen bg-black overflow-hidden">
      ...
      <video
        ...
        muted={!soundEnabled}
      >
        <source src="/assets/animations/Chapter02.mp4" type="video/mp4" />
